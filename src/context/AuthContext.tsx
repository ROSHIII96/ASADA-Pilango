...
//--nuevo
const ROLE_CLAIM_KEY = (typeof process !== "undefined" && process.env.REACT_APP_ROLE_CLAIM_KEY) || "http://schemas.microsoft.com/ws/2008/06/identity/claims/role";
...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  //Nuevo
  // Helper para programar logout automático
