  ...
  return (
    ...
    (
     <div className="pt-16 flex flex-col items-center justify-center mt-20">
      ...
      <p className="text-xl text-gray-500">No hay averias registradas aun.</p>
      <p className="text-sm text-gray-400">Puedes agregar nuevas averias en el boton agregar averias.</p>
    </div>
    )
    :
    (
