  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-800 font-sans px-4 py-6">
      ...
      <header className="text-center mb-10">
        <h1 className="text-4xl font-bold text-blue-700">Reportes y Averías</h1>
        <p className="text-lg text-gray-600 mt-2">Pronto podrás reportar aquí cualquier incidencia.</p>
      </header>
    </div>
  );
};
